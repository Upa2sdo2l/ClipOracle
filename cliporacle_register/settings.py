"""
Django settings for cliporacle_register project.
...
SECRET_KEY = 'django-insecure-wzjaikhd%)$v*=0y5bby0@y&ddo!f5sh^=w2o(#j1)tf7ad5w%'
...
ROOT_URLCONF = 'cliporacle_register.urls'
...
WSGI_APPLICATION = 'cliporacle_register.wsgi.application'
